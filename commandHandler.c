...
int print_intro(int type){
    switch(type) {
        ...
        case 3:
            ...
            break;
        case 4:
            printf("Convolution Calculator: Calculating 2D convolution of two square matrices using assembly.\n");
            break;
        case 5:
